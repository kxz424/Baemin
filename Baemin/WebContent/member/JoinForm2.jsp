...
<div class="cen">
	<div class="center">
		...
		<input class="btn-caution" type="button" value="주의사항 안내 ▼">

		<div class="cau">
			<div class="caution">
				<ul>
					<li>1. 배달의민족 서비스는 만 14세 미만의 아동의 회원가입을 제한하고 있습니다.<br/>2. 정보통신망 이용촉진 및 정보보호 등에 관한 법률에는 만 14세미만 아동의 개인정보 수집 시 법정대리의 동의를 받도록 규정하고 있으며, 생년월일을 허위로 기재하여 법정대리인의 동의없이 회원가입을 하는 경우 회원탈퇴 또는 서비스 이용이 제한 될 수 있음을 안내해 드립니다.</li>
				</ul>
			</div>
		</div>
		...
		<hr/>
		<input type="checkbox" id="chk1"><label for="chk1">이용약관 동의 (필수)</label><br/>
		<input type="checkbox" id="chk2"><label for="chk2">전자금융거래 이용약관 동의 (필수)</label><br/>
		<input type="checkbox" id="chk3"><label for="chk3">개인정보 수집이용 동의 (필수)</label><br/>
		<input type="checkbox" id="chk4"><label for="chk4">개인정보 제 3자 제공 동의 (선택)</label><br/>
		<label class="label1">배달의민족 제휴사에 마케팅정보를 제공합니다.</label><br/>
		<input type="checkbox" id="chk5"><label for="chk5">마케팅 정보 메일, SMS 수신 (선택)</label><br/>
