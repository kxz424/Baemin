...
<div class="container">
	<div class="row">
		...
		<!-- 									</a></li> -->
		<!-- 								</ul> -->
										<a class="accordion-toggle" data-toggle="collapse" href="#collapseRecMenu">추천메뉴</a><span class="caret"></span>
									</h3>
								</div>
										...
										<div class="row rec-menu">
											<div class="col-xs-6 col-sm-4 col-md-4 col-lg-4">
												<div class="thumbnail shop-menu-panel">
													...
													<div class="caption">
														<div class="small">
															<span class="text-ellipsis">쌀통닭</span>
															<strong class="text-ellipsis pull-right">15,900원</strong>
														</div>
													</div>
												</div>
											</div>
											<div class="col-xs-6 col-sm-4 col-md-4 col-lg-4">
												<div class="thumbnail shop-menu-panel">
													...
													<div class="caption">
														<div class="small">
															<span class="text-ellipsis">쌀통닭순살</span>
															<strong class="text-ellipsis pull-right">16,900원</strong>
														</div>
													</div>
												</div>
											</div>
											<div class="col-xs-6 col-sm-4 col-md-4 col-lg-4">
												<div class="thumbnail shop-menu-panel">
													...
													<div class="caption">
														<div class="small">
															<span class="text-ellipsis">불닭발</span>
															<strong class="text-ellipsis pull-right">16,900원</strong>
														</div>
													</div>
												</div>
											...
											<div class="col-xs-6 col-sm-4 col-md-4 col-lg-4">
												<div class="thumbnail shop-menu-panel">
													...
													<div class="caption">
														<div class="small">
															<span class="text-ellipsis">양파뿌린닭</span>
															<strong class="text-ellipsis pull-right">19,900원</strong>
														</div>
													</div>
												</div>
											</div>
											<div class="col-xs-6 col-sm-4 col-md-4 col-lg-4">
												<div class="thumbnail shop-menu-panel">
													...
													<div class="caption">
														<div class="small">
															<span class="text-ellipsis">똥집세트</span>
															<strong class="text-ellipsis pull-right">22,900원</strong>
														</div>
													</div>
												</div>
											</div>
											<div class="col-xs-6 col-sm-4 col-md-4 col-lg-4">
												<div class="thumbnail shop-menu-panel">
													...
													<div class="caption">
														<div class="small">
															<span class="text-ellipsis">옛날통닭두마리</span>
															<strong class="text-ellipsis pull-right">19,900원</strong>
														</div>
													</div>
												</div>
