...
<body>
	...
	<div>
		...
		<div class="div1">
			<label class="label1">약관동의</label> <label class="label2">></label> <label
				class="label1">업주정보</label> <label class="label1">></label> <label
				class="label2 label1-color">업소정보</label>
		</div>
					...
					<div>
						<ul>
							<li class="li-margin li-select">
								<h3>업소정보</h3> <label>업소명</label><br /> <input type="text"
								placeholder="업소명을 입력해 주세요." /> <br />
								<hr /> <label>업소 주소</label> <br /> <select>
									<option>시도</option>
							</select> <select>
									<option>시구군</option>
							</select> <select>
							...
							<br /> <label>업소이미지첨부</label><br /> <input type="file" value=""
								class="" />
							</li>


							<li class="li-margin">
								<h3>운영정보</h3> <label>전화번호</label><br /> <input type="text"
