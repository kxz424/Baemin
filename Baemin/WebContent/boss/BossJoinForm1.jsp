...
<style type="text/css">
	...
	.terms-content {width: 380px; margin:0 auto; margin-top:20px;}
	
	.terms-list {list-style:none; padding-left:0px;}
	
	.terms-check { margin-top:5px; margin-bottom: 5px } 
	
	.label-title { font-size:14px; width: 284px; display:inline-block; }
	
	.terms-all{ font-size:14px;}
	.label-title1 { width: 312px; display:inline-block; }
	...
	.terms {overflow:scroll;  width:350px; height:100px; overflow-x: hidden; background-color: #f4f4f4;}
	.terms_1-1 {font-size: 11px; color: #a6a1a1;}
	.terms_2-1 {font-size: 11px; color: #a6a1a1;}
	.terms_3-1 {font-size: 11px; color: #a6a1a1;}
	.terms_4-1 {font-size: 11px; color: #a6a1a1;}
	
	
	.label-agree {color: #a6a1a1; font-size: 11px;}
	
	#joinTerms{margin:0 auto;}
	
	.btn {width: 170px; height:55px; border:0; outline:0; cursor: pointer; color: #ffffff; font-size: 15px;}
